...
FROZEN_MODEL_FIELDS = {
    ...
    "Release": {'accessibility', 'aspect_ratio', 'audio_channels', 'audio_language', 'audio_present', 'availability_windows', 'available_from', 'available_until', 'bitrate', 'chapters', 'codec', 'color', 'container', 'contents', 'distributor', 'edition', 'external_ids', 'extra', 'frame_rate', 'hdr', 'image', 'label', 'license', 'match_confidence', 'packaging', 'platform', 'region', 'region_locked', 'regions_available', 'relations', 'release_date', 'release_status', 'resolution', 'sample_rate', 'stream_mode', 'subtitle_languages', 'uri', 'work'},
    "Entity": {'aliases', 'birth_year', 'death_year', 'disbanded', 'external_ids', 'extra', 'formed', 'kind', 'memberships', 'name', 'org_kind', 'part_of', 'status', 'years_active'},
